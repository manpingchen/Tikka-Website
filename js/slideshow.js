...
(function (global, factory) {
  ...
  function EventInterface(glide2) {
    var event = glide2.event;
    var key = {};
    var listeners = [];
  ...
  function Options(glide2, Components2, options) {
    ...
    function setup() {
      try {
        merge(options, JSON.parse(getAttribute(glide2.root, DATA_ATTRIBUTE)));
      } catch (e) {
    ...
    function onMatch(point) {
      ...
      if (newOptions.destroy) {
        glide2.options = initialOptions;
        glide2.destroy(newOptions.destroy === "completely");
      } else {
        if (glide2.state.is(DESTROYED)) {
          destroy(true);
          glide2.mount();
        }

        glide2.options = newOptions;
      }
    }
  ...
  function Direction(glide2, Components2, options) {
  ...
  function Elements(glide2, Components2, options) {
    var _EventInterface = EventInterface(glide2),
        on = _EventInterface.on;

    var root = glide2.root;
    var elements = {};
    var slides = [];
    var classes;
    var slider;
  ...
  function Slide$1(glide2, index, slideIndex, slide) {
    var _EventInterface2 = EventInterface(glide2),
        on = _EventInterface2.on,
        emit = _EventInterface2.emit,
        bind = _EventInterface2.bind,
        destroyEvents = _EventInterface2.destroy;

    var Components = glide2.Components,
        root = glide2.root,
        options = glide2.options;
    ...
    function initNavigation() {
      ...
      var controls = glide2.glides.map(function (target) {
        return target.glide.root.id;
      }).join(" ");
    ...
    function isWithin(from, distance) {
      ...
      if (!isClone && (options.rewind || glide2.is(LOOP))) {
        diff = min(diff, glide2.length - diff);
      }
  ...
  function Slides(glide2, Components2, options) {
    var _EventInterface3 = EventInterface(glide2),
    ...
    function register(slide, index, slideIndex) {
      var object = Slide$1(glide2, index, slideIndex, slide);
      object.mount();
      Slides2.push(object);
    }
  ...
  function Layout(glide2, Components2, options) {
    var _EventInterface4 = EventInterface(glide2),
    ...
    function sliderSize() {
      return totalSize(glide2.length - 1, true) - totalSize(-1, true);
    }
  ...
  function Clones(glide2, Components2, options) {
    var _EventInterface5 = EventInterface(glide2),
    ...
    function cloneDeep(elm, index) {
      ...
      clone.id = glide2.root.id + "-clone" + pad(index + 1);
      return clone;
    }
    ...
    function computeCloneCount() {
      ...
      if (!glide2.is(LOOP)) {
        ...
        var baseCount = fixedCount || options[resolve("autoWidth")] && glide2.length || options.perPage;
  ...
  function Move(glide2, Components2, options) {
    var _EventInterface6 = EventInterface(glide2),
    ...
    function trim(position) {
      if (options.trimSpace && glide2.is(SLIDE)) {
    ...
    function isBusy() {
      return glide2.state.is(MOVING) && options.waitForTransition;
    }
  ...
  function Controller(glide2, Components2, options) {
    var _EventInterface7 = EventInterface(glide2),
    ...
    var isLoop = glide2.is(LOOP);
    var isSlide = glide2.is(SLIDE);
  ...
  function Arrows(glide2, Components2, options) {
    var _EventInterface8 = EventInterface(glide2),
    ...
    function createArrows() {
      ...
      before(wrapper, child(options.arrows === "slider" && Elements.slider || glide2.root));
    }
  ...
  function Autoplay(glide2, Components2, options) {
    var _EventInterface9 = EventInterface(glide2),
        on = _EventInterface9.on,
        bind = _EventInterface9.bind,
        emit = _EventInterface9.emit;

    var interval = RequestInterval(options.interval, glide2.go.bind(glide2, ">"), update);
    ...
    function updateInterval() {
      var Slide = Components2.Slides.getAt(glide2.index);
  ...
  function Cover(glide2, Components2, options) {
    var _EventInterface10 = EventInterface(glide2),
  ...
  function Scroll(glide2, Components2, options) {
    var _EventInterface11 = EventInterface(glide2),
    ...
    function scroll(destination, duration, callback, suppressConstraint) {
      ...
      interval = RequestInterval(duration, onScrolled, function (rate) {
        ...
        if (glide2.is(SLIDE) && !suppressConstraint && exceededLimit()) {
    ...
    function onScrolled() {
      ...
      if (!between(index, 0, glide2.length - 1)) {
  ...
  function Drag(glide2, Components2, options) {
    var _EventInterface12 = EventInterface(glide2),
    ...
    function constrain(diff) {
      return diff / (hasExceeded && glide2.is(SLIDE) ? FRICTION : 1);
    }
  ...
  function Keyboard(glide2, Components2, options) {
    var _EventInterface13 = EventInterface(glide2),
  ...
  function LazyLoad(glide2, Components2, options) {
    var _EventInterface14 = EventInterface(glide2),
    ...
    function observe() {
      images = images.filter(function (data) {
        ...
        if (data._Slide.isWithin(glide2.index, distance)) {
          return load(data);
        }
  ...
  function Pagination(glide2, Components2, options) {
    var _EventInterface15 = EventInterface(glide2),
  ...
  function Sync(glide2, Components2, options) {
    var list = Components2.Elements.list;
    var events = [];

    function mount() {
      glide2.glides.forEach(function (target) {
        !target.isParent && sync(target.glide);
      });
    ...
    function sync(glide) {
      [glide2, glide].forEach(function (instance) {
        var event = EventInterface(instance);
        var target = instance === glide2 ? glide : glide2;
    ...
    function navigate() {
      var event = EventInterface(glide2);
      var on = event.on;
      ...
      events.push(event);
      event.emit(EVENT_NAVIGATION_MOUNTED, glide2.glides);
    }
  ...
  function Wheel(glide2, Components2, options) {
    var _EventInterface16 = EventInterface(glide2),
    ...
    function shouldPrevent(backwards) {
      return !options.releaseWheel || glide2.state.is(MOVING) || Components2.Controller.getAdjacent(backwards) !== -1;
    }
  ...
  function Fade(glide2, Components2, options) {
    var _EventInterface17 = EventInterface(glide2),
  ...
  function Slide(glide2, Components2, options) {
    var _EventInterface18 = EventInterface(glide2),
    ...
    function getSpeed(index) {
      ...
      if (glide2.is(SLIDE) && rewindSpeed) {
  ...
  var _glide = /*#__PURE__*/function () {
    function _glide(target, options) {
      this.event = EventBus();
      this.Components = {};
      ...
      this.root = root;
      merge(DEFAULTS, _glide.defaults);
      merge(merge(this._options, DEFAULTS), options || {});
    }

    var _proto = _glide.prototype;
    ...
    _proto.sync = function sync(glide) {
      this.glides.push({
        glide: glide
      });
      glide.glides.push({
